...
export interface ApiAboutMeSectionAboutMeSection extends Schema.SingleType {
  collectionName: 'about_me_sections';
  info: {
    singularName: 'about-me-section';
    pluralName: 'about-me-sections';
  ...
  attributes: {
    ...
    experience_date: Attribute.Date;
    ...
    createdBy: Attribute.Relation<
      'api::about-me-section.about-me-section',
      'oneToOne',
      'admin::user'
    > &
      Attribute.Private;
...
export interface ApiGenreEnumGenreEnum extends Schema.CollectionType {
...
export interface ApiProjectProject extends Schema.CollectionType {
  ...
  attributes: {
    ...
    directors: Attribute.Component<'name.directors', true>;
    producers: Attribute.Component<'name.producers', true>;
    timestamp: Attribute.Component<'timestamp.timestamp'>;
...
export interface ApiRoleEnumRoleEnum extends Schema.CollectionType {
...
declare module '@strapi/types' {
  export module Shared {
    export interface ContentTypes {
      ...
      'api::about-me-section.about-me-section': ApiAboutMeSectionAboutMeSection;
      'api::contact.contact': ApiContactContact;
      'api::doc.doc': ApiDocDoc;
      'api::genre-enum.genre-enum': ApiGenreEnumGenreEnum;
      'api::hero-section.hero-section': ApiHeroSectionHeroSection;
      'api::project.project': ApiProjectProject;
      'api::role-enum.role-enum': ApiRoleEnumRoleEnum;
